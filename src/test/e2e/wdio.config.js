...
var config = {
  ...
  capabilities: [{
    ...
    'phantomjs.binary.path': '/var/apps/mccloud/node_modules/phantomjs-prebuilt/bin/phantomjs'
  }],
  //
  // ===================
  // Test Configurations
  ...
  screenshotPath: './src/test/e2e/errorShots/',
  //
  // Set a base URL in order to shorten url command calls. If your url parameter starts
  // with "/", the base url gets prepended.
  baseUrl: 'http://localhost:8080/mccloud',
  //
  ...
  reporters: ['spec'],
  reporterOptions: {
    outputDir: './target/reports/fed/xunit'
  },
  //
  ...
  jasmineNodeOpts: {
    ...
    // an assertion fails.
    // expectationResultHandler: function expectationResultHandler(passed, assertion) {
    //   // do something
...
if (program.services) {
  Object.assign(config, {
    services: ['sauce'],
    user: 'Sajjan',
    key: '498ae31f-193d-4c00-8e67-b0c7495ddeb5',
    sauceConnect: true,
    capabilities: [{
      browserName: 'chrome',
      version: '48.0',
